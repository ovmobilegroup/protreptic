...
- git 提交: `ee992a4237dc24b32ccb7b500c8ce0e7ee0ac153`；发布仓镜像: `62fa7af230b2ad0d5618a8166c13385360d69eab`
...
- 逐页断言: **3038 PASS / 0 FAIL**（`verify_legacy20_r6_archive.py` 载入证据后含冻结时点复核 16 项；未载证据时为 3022；exit 0）。覆盖: 九节结构与段序/空行；头部全部字段逐字；§三 10 模式全字段逐字（空字段以「（空）」计数核验）；§四 场景双语逐字；§五/§六/§七/§八 逐字；§九 登记链五段（卡号/执行者/提交号）、pending 口径、evidence 原文、缺项登记、计数台账、归档 sha 复核；尾随空白仅来自源档；无三重换行/无替换符/末行换行。
...
- 镜像动作: 本卡路径 20 件（10 页 + 8 归档件 + 本报告 + 证据）镜像至发布仓；提交 `62fa7af230b2ad0d5618a8166c13385360d69eab`；推送 main 后 远端 main 复核等同（推送区间 70c97ab..62fa7af）；报告/证据 v2 以第二次镜像提交随行（提交 4c5eb84ade217dafd29c845720ab52a7503e2c46，推送区间 62fa7af 至 4c5eb84，远端 main 复核等同）。
- 收口水位: 8 条（开工水位 8；本卡路径全部收敛，差数不增；余量为 QA 卡交付物，建议收尾卡镜像，见 §七）。
