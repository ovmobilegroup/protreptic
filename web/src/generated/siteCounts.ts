...
export const SITE_COUNTS = {
  ...
  description: "3271 条思维模式 × 323 位历史人物：每条都有出处、操作步骤与现代应用。以人为鉴，明得失。",
  /** og:description / 页脚文案 (与 site_counts.og_description_text 同值) */
  ogDescription: "3271 条思维模式 × 323 位历史人物 · 中英双语",
  /**
   ...
   */
  verification: {
    published: { verified: 1019, pending: 1875, suspect: 37, unverifiable: 340 },
    publishedTotal: 3271,
    all: { verified: 1019, pending: 1907, suspect: 54, unverifiable: 351 },
    allTotal: 3331,
    quarantinedTotal: 60,
   ...
   */
  citationLinks: {
    modesWithCitations: 2532,
    modesWithLink: 1046,
    citations: 4547,
    citationsLinked: 1301,
    citationsRegisteredUnlinkable: 942,
    citationsUnresolved: 2304,
    segments: 4610,
    segmentsLinked: 1320,
  },
} as const
